...
class State:
    ...
    def legal_actions(self):
        # 오셀로에서의 둘 수 있는 수란 놓여 있지 않은 장소 중에서 돌을 놓았을 때
        # 상대방의 돌을 중심으로 8방향 중 포위를 할 수 있는 장소다.
        # 둘 수 있는 수가 없는 경우, 패스(36)을 반환.
        actions = []
        for j in range(0, 6):
            for i in range(0, 6):
    ...
    def is_legal_action_xy(self, x, y, flip=False):
        # 8방향 중 어느 한 방향이라도 상대의 돌을 포위할 수 있는지 계산하기 위해 사용
        # 인수 x와 y는 매스의 xy좌표, flip은 포위한 돌을 뒤집는지의 여부
